...
function ExperienceItem(props) {
    return (
        <div className="group flex flex-row mb-4 p-5 transition-all border border-surface-600 rounded-lg hover:bg-surface-200/70 hover:scale-105 cursor-pointer text-surface-500 hover:text-on-background">
            ...
            <div className='basis-3/4'>
                <a href={props.href} target="_blank" rel="noopener noreferrer" className='font-semibold transition-all hover:underline text-surface-100'>{props.title} | {props.company} </a>
